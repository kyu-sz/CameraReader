...
#define decode_buf_VIDEO_SRC               (1) //mixed input,total src buffer size;splited input,video src buffer size 
#define decode_buf_AUDIO_SRC               (2) //mixed input,not defined;splited input,audio src buffer size
#define decode_buf_VIDEO_RENDER            (3) //video render node count 
#define decode_buf_AUDIO_RENDER            (4) //audio render node count 
#define decode_buf_VIDEO_DECODED           (5) //video decoded node count to render
#define decode_buf_AUDIO_DECODED           (6) //audio decoded node count to render
#define decode_buf_DISPLAY_NODE            (7) //display node
...
#define SOURCE_decode_buf_MIN	1024*50
